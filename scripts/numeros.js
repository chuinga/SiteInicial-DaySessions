const atualizaContagem = (elemento) => {
    ...
    const valor = parseInt(elemento.dataset.value); // parseInt --> produz um valor inteiro
    ...
    const aumentaContagem = setInterval(() => {
        ...
        elemento.textContent = `${valorInicial}`; // Atualiza o texto do elemento para o valor inicial
    }, 20); // O intervalo de tempo é definido como 1 milissegundo
};
